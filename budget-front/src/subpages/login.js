...
export default function Login(){
    ...
    return(
        <Flex bg="#f8f9fa" h="76vh" w="72vw" flexDir="row" borderRadius="36px">
            ...
            <Flex className="image-box" h="inherit" w="50%" borderRadius="3xl" justify="center" align="center">
                <Image className="image" src={welcome2} boxSize="98%" borderRadius="32px"/>
            </Flex>
        </Flex>
    )
}